...
import 'package:ntpc_garbage_map/services/ntpc_garbage_service.dart'; // 更新引用
...
void main() {
  ...
  group('Versioned Local Import & UI Tests', () {
    ...
    setUp(() async {
      ...
      tempCsv = File('${tempDir.path}/test_routes.csv');
    ...
    testWidgets('AppBar display record count', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            garbageServiceProvider.overrideWithValue(service),
          ],
      ...
      expect(find.textContaining('快取'), findsOneWidget);
    });
